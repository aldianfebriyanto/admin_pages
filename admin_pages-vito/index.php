 ...
 <body class="fix-header fix-sidebar card-no-border">
    ...
    <div id="main-wrapper">
            ...
            <div class="scroll-sidebar" >
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark" href="#"onclick="openPage('tabel.php')" aria-expanded="false"><i class="fa fa-tables"></i><span class="hide-menu">Schedule</span></a>
                        </li>
                        ...
                        <li> <a class="waves-effect waves-dark" href="#" onclick="openPage('home1.html')" aria-expanded="false"><i class="fa fa-bookmark-o"></i><span class="hide-menu">Store</span></a>
                        </li>
        ...
        <div class="page-wrapper" id="page-content" style="margin-top: -60px;">
            <!-- footer -->
            <!-- ============================================================== -->
            <footer class="footer text-center" style="margin-left: 250px;">© 2018 KFC Admin Page by error 404</footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
        </div>
